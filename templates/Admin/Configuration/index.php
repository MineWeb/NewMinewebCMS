        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex align-items-center justify-content-between flex-wrap" style="gap: 10px;">
                    <div>
                        <h1 class="m-0"><?= __('CONFIG__GENERAL_PREFERENCES') ?></h1>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-globe mr-2"></i><?= __('CONFIG__GENERAL_PREFERENCES') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <?php if ($shopIsInstalled) : ?>
                                            <div class="card mb-3">
                                                <div class="card-header">
                                                    <h3 class="card-title mb-0 text-sm">
                                                        <i class="fas fa-shopping-cart mr-2"></i><?= __('SHOP') ?>
                                                    </h3>
                                                </div>
                                                <div class="card-body">
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-file-signature mr-2"></i><?= __('CONFIG__CONDITION_TITLE') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <small class="form-text text-danger"><?= __('CONFIG__CONDITION') ?></small>
                                                </div>
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-code-branch mr-2"></i><?= __('CONFIG__KEY_VERSION') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-language mr-2"></i><?= __('CONFIG__KEY_LANG') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-user-lock mr-2"></i><?= __('CONFIG__KEY_PASSWORDS_HASH') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-id-badge mr-2"></i><?= __('CONFIG__CHECK_UUID') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fab fa-microsoft mr-2"></i><?= __('CONFIG__MICROSOFT_CONNECTION') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-hourglass-half mr-2"></i><?= __('CONFIG__KEY_SESSION_TYPE') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <small class="form-text text-info"><?= __('CONFIG__KEY_SESSION_TYPE_INFO') ?></small>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-users mr-2"></i><?= __('CONFIG__KEY_MEMBER_PAGE_TYPE') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-envelope-open-text mr-2"></i><?= __('CONFIG__KEY_CONFIRM_MAIL_SIGNUP') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                                ...
                                                >
                                                    <div class="alert alert-info mb-0">
                                                        ...
                                                        <div class="custom-control custom-radio">
                                                            ...
                                                            >
                                                            <label class="custom-control-label" for="confirm-mail-signup-block-enable">
                                                                <?= __('GLOBAL__ENABLE') ?>
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="custom-control custom-radio mb-0">
                                                            ...
                                                            >
                                                            <label class="custom-control-label" for="confirm-mail-signup-block-disable">
                                                                <?= __('GLOBAL__DISABLE') ?>
                                                            </label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-shield-alt mr-2"></i><?= __('CONFIG__KEY_CAPTCHA_TYPE') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-chart-line mr-2"></i><?= __('CONFIG__KEY_GOOGLE_ANALYTICS') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-code mr-2"></i><?= __('CONFIG__KEY_END_LAYOUT_COE') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card mb-0">
                                            <div class="card-header">
                                                <h3 class="card-title mb-0 text-sm">
                                                    <i class="fas fa-paper-plane mr-2"></i><?= __('CONFIG__KEY_EMAIL_SEND_TYPE') ?>
                                                </h3>
                                            </div>
                                            <div class="card-body">
