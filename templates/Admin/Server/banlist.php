...
$searchId = 'banlist-search';
$tableId = 'banlist-table';
$emptyId = 'banlist-empty';
$countId = 'banlist-count';
...
$selfBaseUrl = $this->Url->build(['_name' => 'admin_server_banlist']);
                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between flex-wrap" style="gap: 10px;">
                            <div class="d-flex align-items-center flex-wrap" style="gap: 10px;">
                                <h3 class="card-title mb-0">
                                    <i class="fas fa-user-slash mr-2"></i><?= __('SERVER__BANLIST') ?>
                                </h3>
                        ...
                        <div class="mt-3">
                            <div class="d-flex align-items-center flex-wrap" style="gap: 6px;">
                                <a class="btn btn-sm <?= $currentServerId === 0 ? 'btn-danger' : 'btn-outline-danger' ?>"
                                   href="<?= h($selfBaseUrl) ?>">
                                    <i class="fas fa-layer-group mr-1"></i><?= __('SERVER__ALL_SERVERS') ?>
                                </a>
                                ...
                                <?php foreach ($servers as $value): ?>
                                    ...
                                    $href = $active
                                        ? $selfBaseUrl
                                        : $this->Url->build(['_name' => 'admin_server_banlist', $sid]);
                                    ?>
                                    <a class="btn btn-sm <?= $active ? 'btn-danger' : 'btn-outline-danger' ?>"
                                       href="<?= h($href) ?>">
