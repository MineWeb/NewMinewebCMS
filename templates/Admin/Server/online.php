...
$searchId = 'online-search';
$tableId = 'online-table';
$emptyId = 'online-empty';
$countId = 'online-count';
                    ...
                    <div class="card-header">
                        ...
                        <div class="mt-3">
                            <div class="d-flex align-items-center flex-wrap" style="gap: 6px;">
                                <a class="btn btn-sm <?= $currentServerId === 0 ? 'btn-success' : 'btn-outline-success' ?>"
                                   href="<?= h($selfBaseUrl) ?>">
                                    <i class="fas fa-layer-group mr-1"></i><?= __('SERVER__ALL_SERVERS') ?>
                                </a>
                                ...
                                <?php foreach ($servers as $value): ?>
                                    ...
                                    $href = $active
                                        ? $selfBaseUrl
                                        : $this->Url->build(['_name' => 'admin_server_online', $sid]);
                                    ?>
                                    <a class="btn btn-sm <?= $active ? 'btn-success' : 'btn-outline-success' ?>"
                                       href="<?= h($href) ?>">
