    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" data-ajax="true" data-redirect-url="<?= Router::url(['controller' => 'maintenance', 'action' => 'index', 'admin' => 'true']) ?>">
                        ...
                        <div class="float-right">
                            <a href="<?= Router::url(['controller' => 'maintenance', 'action' => 'index', 'admin' => true, $page["id"]]) ?>"
