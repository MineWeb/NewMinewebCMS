                                    ...
                                    <select class="form-control" name="url_plugin">
                                        ...
                                        foreach ($url_plugins as $pluginId => $data) {
                                            ...
                                            foreach ($data->routes as $name => $route)
                                                echo '<option value=\'' . json_encode(['id' => $pluginId, 'route' => $route]) . '\' ' . ($nav['urlData']['type'] === 'plugin' && $nav['urlData']['id'] === $pluginId && $nav['urlData']['route'] === $route ? ' selected' : '') . '>' . $name . ' (' . $route . ')</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                                ...
                                <div class="page<?= ($nav['urlData']['type'] == "page") ? '' : ' d-none' ?>">
                                    <select class="form-control" name="url_page">
                                        <?php foreach ($url_pages as $key => $value) { ?>
                                            <option value="<?= $key ?>"<?= (isset($nav['urlData']['id']) and $nav['urlData']['id'] == $key) ? ' selected' : '' ?>><?= $value ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="radio">
