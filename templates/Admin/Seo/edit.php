            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="seo-page"><?= __('SEO__PAGE') ?></label><br>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="seo-title"><?= __('SEO__FORM_TITLE') ?></label><br>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="seo-description"><?= __('SEO__FORM_DESCRIPTION') ?></label><br>
                                <em><?= __('SEO__KEEP_EMPTY') ?></em>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <em> <?= __('SEO__FORM_FAVICON_DESC') ?></em><br>
                                <em><?= __('SEO__KEEP_EMPTY') ?></em>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <em> <?= __('SEO__FORM_IMG_URL_DESC') ?></em><br>
                                <em><?= __('SEO__KEEP_EMPTY') ?></em>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <em> <?= __('SEO__FORM_THEME_COLOR_DESC') ?></em><br>
                                <em><?= __('SEO__KEEP_EMPTY') ?></em>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="seo-twitter-site">
                                    <?= __('SEO__FORM_TWITTER_SITE') ?>
                                </label>
                                <em> <?= __('SEO__FORM_TWITTER_SITE_DESC') ?></em><br>
                                <em><?= __('SEO__KEEP_EMPTY') ?></em>
                    ...
                    <div class="float-right">
                        <a href="<?= $this->Url->build(['_name' => 'admin_seo_index']) ?>"
