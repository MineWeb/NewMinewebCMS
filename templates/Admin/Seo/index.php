    ...
    <div class="row">
        <div class="col-md-12">
            <div class="callout callout-danger">
                <h4><?= __('SEO__CALLOUT') ?></h4><?= __('SEO__CALLOUT_MESSAGE') ?>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?= Router::url(['controller' => 'seo', 'action' => 'edit_default', 'admin' => 'true']) ?>"
                        ...
                        <button class="btn btn-primary float-right" type="submit"><?= __('GLOBAL__SUBMIT') ?></button>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-large btn-block btn-primary"
                       href="<?= Router::url(['controller' => 'seo', 'action' => 'add', 'admin' => true]) ?>"><?= __('SEO__ADD_PAGE') ?></a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info"
                                       href="<?= Router::url(['action' => 'edit', 'admin' => true, $v['id']]) ?>"><?= __('GLOBAL__EDIT') ?></a>
