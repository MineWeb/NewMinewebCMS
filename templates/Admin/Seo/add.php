                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between flex-wrap" style="gap:10px;">
                            <h3 class="card-title mb-0">
                                <i class="fas fa-plus-circle mr-2"></i><?= __('SEO__ADD_PAGE') ?>
                            </h3>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="p-3 p-md-4">
                            ...
                            <div class="alert alert-light border d-flex align-items-start mb-4">
                                ...
                                <div class="text-sm mb-0"><?= __('SEO__ADD_INTRO') ?></div>
                            </div>
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input
                                                ...
                                                autocomplete="off"
                                                aria-describedby="seo-page-help"
                                            >
                                        </div>

                                        <small id="seo-page-help" class="form-text text-muted mt-2 mb-0">
                                    ...
                                    <div class="card mb-0">
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between mb-2">
                                                ...
                                                <span class="badge badge-light js-empty-badge" data-empty-for="#seo-favicon-add-root"><?= __('SEO__KEEP_EMPTY') ?></span>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span class="badge badge-light ml-3" style="min-width: 92px; text-align:center;">
                                                    <span id="seo-theme-color-value"></span>
                                                </span>
                                            </div>
...
<script>
    (function () {
        ...
        const isUploadWidgetEmpty = (rootEl) => {
            if (!rootEl) return true;
            const hasEdit = !!rootEl.querySelector('input[name$="[edit]"]');
            const hasDelete = (rootEl.querySelector('input[name$="[delete]"]')?.value || '0') === '1';
        ...
        const updateBadges = () => {
            ...
            for (const badge of badges) {
                ...
                if (el.tagName === 'INPUT' || el.tagName === 'TEXTAREA' || el.tagName === 'SELECT') {
                    ...
                    isEmpty = isUploadWidgetEmpty(el);
                }
