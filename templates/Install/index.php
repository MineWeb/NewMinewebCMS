    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tabsleft-tab2">
            ...
            <form id="step3">
                ...
                <?php } ?>
                <div id="input"></div>
                <li class="next finish hidden" style="display: none;"><a
                        href="javascript:"><?= $Lang->get('GLOBAL__END') ?></a></li>
                <ul class="pager wizard">
                    <li class="next" style="display: inline;"><a id="tabsleft-link"
                                                                 href="javascript:"><?= $Lang->get('GLOBAL__NEXT') ?></a>
                    </li>
                    <li class="next finish hidden" style="display: none;"><a
                            href="javascript:"><?= $Lang->get('GLOBAL__END') ?></a></li>
                </ul>
