...
if (!$compatible['intl']) {
    $help['intl'] = 'L extension intl doit etre activee.';
}

$compatible['mbstring'] = extension_loaded('mbstring');
if (!$compatible['mbstring']) {
    $help['mbstring'] = 'L extension mbstring doit etre activee.';
}

$compatible['icu'] = true;
if ($compatible['intl']) {
    if (defined('INTL_ICU_VERSION')) {
        $compatible['icu'] = version_compare(INTL_ICU_VERSION, '50.1', '>=');
        if (!$compatible['icu']) {
            $help['icu'] = 'ICU doit etre en version 50.1 ou plus. Version actuelle: ' . INTL_ICU_VERSION . '.';
        }
    } else {
        $compatible['icu'] = false;
        $help['icu'] = 'Impossible de determiner la version ICU. Verifiez la configuration de l extension intl.';
    }
}

$configDir = $root . DIRECTORY_SEPARATOR . 'config';
$dataDir = $root . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'Data';
$pluginsDir = $root . DIRECTORY_SEPARATOR . 'plugins';
$tmpDir = $root . DIRECTORY_SEPARATOR . 'tmp';
$jsDir = $root . DIRECTORY_SEPARATOR . 'webroot' . DIRECTORY_SEPARATOR . 'js';

$compatible['chmod'] =
    is_writable($configDir) &&
    is_writable($dataDir) &&
    is_writable($pluginsDir) &&
    is_writable($tmpDir) &&
    is_writable($jsDir);
...
if (!$compatible['xml']) {
    $help['xml'] = 'L extension xml doit etre activee.';
}

$compatible['openSSL'] = extension_loaded('openssl');
if (!$compatible['openSSL']) {
    $help['openSSL'] = 'L extension openssl doit etre activee.';
}
...
$needCompatibilityView = in_array(false, $compatible, true);

if (!$needCompatibilityView) {
    return;
}

if (!function_exists('affichImg')) {
...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/css/install/flat.css">
        <link rel="stylesheet" href="/css/install/animate.min.css">
    ...
    <div class="container" style="max-width:700px">
        <svg width="160px" height="160px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"
             preserveAspectRatio="xMidYMid" class="loader">
            <rect x="0" y="0" width="100" height="100" fill="none" class="bk"></rect>
            <rect x="48.5" y="40" width="3" height="20" rx="5" ry="5"
        ...
        <div class="compatibilite" style="display:none;">
            <table class="table">
                ...
                <tr>
                    ...
                    <td><?= affichImg($compatible['intl']) ?></td>
                </tr>
                <?php if (!$compatible['intl'] && isset($help['intl'])): ?>
                    <tr>
                        <td colspan="2">
                            <div class="panel panel-default">
                                <div class="panel-body"><?= $help['intl'] ?></div>
                            </div>
                        </td>
                    </tr>
                <?php endif; ?>
                <tr>
                    <td>ICU >= 50.1</td>
                    <td><?= affichImg($compatible['icu']) ?></td>
                </tr>
                <?php if (!$compatible['icu'] && isset($help['icu'])): ?>
                    <tr>
                        <td colspan="2">
                            <div class="panel panel-default">
                                <div class="panel-body"><?= $help['icu'] ?></div>
                            </div>
                        </td>
                    </tr>
                <?php endif; ?>
                <tr>
                    ...
                    <td><?= affichImg($compatible['mbstring']) ?></td>
                </tr>
                <?php if (!$compatible['mbstring'] && isset($help['mbstring'])): ?>
                    <tr>
                        <td colspan="2">
                            <div class="panel panel-default">
                                <div class="panel-body"><?= $help['mbstring'] ?></div>
                            </div>
                        </td>
                    </tr>
                <?php endif; ?>
                ...
                <?php endif; ?>
                <tr>
                    <td>Reecriture d URL .htaccess actives</td>
                ...
                <?php endif; ?>
                <tr>
                    <td>Ouverture d un zip (mise a jour)</td>
                ...
                <?php if (!$compatible['openSSL'] && isset($help['openSSL'])): ?>
                    <tr>
                        <td colspan="2">
                            <div class="panel panel-default">
                                <div class="panel-body"><?= $help['openSSL'] ?></div>
                            </div>
                        </td>
                    </tr>
                <?php endif; ?>
                <tr>
                    <td>Ouverture d un site a distance (mise a jour)</td>
                    <td><?= affichImg($compatible['allowGetURL']) ?></td>
                </tr>
                </tbody>
            </table>
            <div class="alert alert-danger"><b>Erreur :</b> Votre hebergeur n a pas les prerequis.</div>
        </div>
    </div>

    <script src="/js/install/requirements.js"></script>
    </body>
    </html>
<?php
exit;
