...
<head>
    ...
    <link rel="stylesheet"
          href="https://fonts.googleapis.com/css?family=Roboto:400,300,500,700' rel='stylesheet' type='text/css">
    <link rel="stylesheet" href="css/install/flat.css" media="screen" title="no title" charset="utf-8">
    <link rel="stylesheet" href="css/install/animate.min.css">
    <link rel="stylesheet" href="css/install/install.css" media="screen" title="no title" charset="utf-8">
...
<div class="container" style="max-width:700px">
    ...
    <div class="first center" style="display:none;">
        <h1>Bienvenue,</h1>
        <p>Dans l'installation de MineWeb, merci d'avoir choisi notre CMS ! Vous allez maintenant pouvoir procéder à
            l'installation du site en toute simplicité.</p>
    </div>
