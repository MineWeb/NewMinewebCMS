...
<div class="container" style="max-width:700px">
    <svg width="160px" height="160px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"
        ...
        <rect x="48.5" y="40" width="3" height="20" rx="5" ry="5" fill="#7c7e7f"
    ...
    <div class="database"
         style="display:none;"
         data-need-to-display="<?= $needDisplayDatabase ? 'true' : 'false' ?>"
    ...
    >
        <form id="saveDB">
            ...
            <div id="mysql_require">
                <div class="form-group">
                    <label>Adresse de la base de donnees</label>
    ...
    <button type="submit" class="btn btn-primary btn-block installSQL" style="display:none;">
...
<script>
    ...
    if (typeSelect && mysqlRequire) {
        function updateMysqlRequire() {
        ...
        typeSelect.addEventListener('change', updateMysqlRequire)
        updateMysqlRequire()
    }
