...
return [
    'Update' => [
        ...
        'addons' => [
            ...
            'markets' => [
                [
                    'key' => (string)env('UPDATE_ADDONS_MARKET_1_KEY', 'public'),
                    'name' => (string)env('UPDATE_ADDONS_MARKET_1_NAME', 'GitHub Public'),
                    'url' => (string)env('UPDATE_ADDONS_MARKET_1_URL', 'https://github.com/MineWeb'),
                ...
                [
                    'key' => (string)env('UPDATE_ADDONS_MARKET_2_KEY', 'premium'),
                    'name' => (string)env('UPDATE_ADDONS_MARKET_2_NAME', 'Premium Market'),
                    'url' => (string)env('UPDATE_ADDONS_MARKET_2_URL', ''),
                ...
                [
                    'key' => (string)env('UPDATE_ADDONS_MARKET_LOCAL_KEY', 'local'),
                    'name' => (string)env('UPDATE_ADDONS_MARKET_LOCAL_NAME', 'Local'),
                    'url' => (string)env('UPDATE_ADDONS_MARKET_LOCAL_URL', ''),
        ...
        'themes' => [
            ...
            'markets' => [
                [
                    'key' => (string)env('UPDATE_THEMES_MARKET_1_KEY', 'public'),
                    'name' => (string)env('UPDATE_THEMES_MARKET_1_NAME', 'GitHub Public'),
                    'url' => (string)env('UPDATE_THEMES_MARKET_1_URL', 'https://github.com/MineWeb'),
                ...
                [
                    'key' => (string)env('UPDATE_THEMES_MARKET_2_KEY', 'premium'),
                    'name' => (string)env('UPDATE_THEMES_MARKET_2_NAME', 'Premium Themes'),
                    'url' => (string)env('UPDATE_THEMES_MARKET_2_URL', ''),
                ...
                [
                    'key' => (string)env('UPDATE_THEMES_MARKET_LOCAL_KEY', 'local'),
                    'name' => (string)env('UPDATE_THEMES_MARKET_LOCAL_NAME', 'Local'),
                    'url' => (string)env('UPDATE_THEMES_MARKET_LOCAL_URL', ''),
